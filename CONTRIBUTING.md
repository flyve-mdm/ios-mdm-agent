...
Welcome to our ever growing community! We are more than happy to accept external contributions to the project in the form of feedback, [translating](http://flyve.org/ios-mdm-agent/howtos/contribute-translating), bug reports and even better, pull requests!
...
Before submitting the issue please check the [issue tracker](https://github.com/flyve-mdm/ios-mdm-agent/issues), there exists the possibility that the bug was already reported by other contributor.
...
You can file new issues by filling out our [new issue form](https://github.com/flyve-mdm/ios-mdm-agent/issues/new).
...
* In GitHub, send a pull request to our [Repository](https://github.com/flyve-mdm/ios-mdm-agent).
